...
She swiped her hand. The amber interface shifted. <em>EXECUTE: MODULATION_PROTOCOL.</em> An unauthorized frequency shift was requested, targeting a pitch shift of plus two octaves to hit 1.2 kHz. <em>WARNING: WARRANTY_VOID.</em> The security kernel was bypassed, the administrative alert neutralized. SDI: 0.95, HIQ: 0.88. Phase Drift Coefficient: 0.45.

It was illegal [[Modulation::The unauthorized modification of one's own soul, a crime against the Grand Concord's absolute order.]] .
...
She tapped the amber console. A map appeared. It was a schematic of the city's lower levels—the infrastructure tunnels beneath the Academy.
...
She offered him a small, data-chip. It was old tech—a physical drive, black and unmarked.

"If you ever want to see what you really look like," she said, "without the hull... come find us."

Taro took the chip. It felt warm. <em>ITEM_ACQUIRED: ENCRYPTED_KEY [DEAD_ZONE].</em> The acoustic signature was confirmed, targeting the sub-bass sector. My system flagged a crossroads, a neural variance threshold identified. A decision was required.
