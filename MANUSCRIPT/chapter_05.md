...
Taro took a breath. He located the variable oscillation in his chest. The High Register. He tried to dampen it. He tried to shape it into a smooth, polite sine wave like the others, but it felt like trying to smooth out broken glass with his bare hands. In this world, we are taught that to be human is to be unpredictable, but in the Sandbox, to be unpredictable is to be deleted.

He restricted his bio-plasma discharge rate to twenty percent. <em>OUTPUT: 20%.</em>

A jagged, yellow lightning bolt arced from Taro toward Hana. It hit her blue firewall shield and... bounced off.

*CRACK.*

*PHASE_MISMATCH.* Incoming signal offset was ninety degrees, the system rejecting my dissonance as it struggled to find the required alignment for constructive interference. Energy loss hit forty-five percent as the amplitude was nullified.
...
Taro's frustrated signal spiked. He felt the surge in his chest—the familiar, painful heat of the High Register wanting to break containment. <em>OUTPUT: 95% [CRITICAL].</em> Buffer overflow was imminent, the sensation like a burning wire mapping out every neural pathway in his arm.
...
The entire wireframe grid of the Sandbox rolled like liquid. A massive, subsonic pulse wave expanded from Ven, blowing Hana's hair back. <em>CONSTRUCTIVE INTERFERENCE.</em> Perfect phase alignment detected at a subsonic level, the signal translated into a 20 Hz sub-bass wave that generated a staggering 4,200 Score Units.
...
Ven looked up. His eyes—usually half-closed—were wide open. The pupils were vibrating. <em>NODE_STATUS: VEN [CHARGED].</em> Available capacity was down to fifteen percent as he absorbed 440V of raw output. System overcharge detected, but his temporary buffer was holding at two hundred percent.

"Whoa," Ven said. His voice rumbled in Taro's chest like a subwoofer hitting a resonant frequency. "My buffer is clean, Taro. I'm running deep for once. I've never been <em>full</em>."

He was smiling a quiet, sleepy smile, but his aura was vast, golden, and terrifyingly solid.
Hana stared at the telemetry stream. <em>TOTAL_OUTPUT: 140dB [LETHAL].</em>
