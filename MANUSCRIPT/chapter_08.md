...
<summary><strong>LORE</strong></summary>
<blockquote>
<strong>Observation:</strong> VOCAL_ANALYSIS: SATO_REMI — REGISTER: NON-TACTICAL `CONTENT: FILED FOR REVIEW — PRIORITY: LOW`` `COLLAR: ACTIVE — SUPPRESSION: 78%`` `RESIDUAL: 22%```
<br><br>
<strong>- Source: In-World Text</strong>
</blockquote>
</details>
